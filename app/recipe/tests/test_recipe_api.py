...
class PublicRecipeApiTests(TestCase):
    """Test unauthenticated recioe API access"""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_retrieve_recipes_user(self):
        """Test retrieving  list of recipes only for current user"""
    ...
    def test_create_recipe_with_tags(self):
        """terst creating recipe with tags"""
        tag1 = sample_tag(user=self.user, name='Vegan')
        tag2 = sample_tag(user=self.user, name='Polish')
    ...
    def test_create_recipe_with_ingredients(self):
        """terst creating recipe with ingredients"""
